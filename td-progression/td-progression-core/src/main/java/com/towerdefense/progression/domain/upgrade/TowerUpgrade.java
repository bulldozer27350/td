...
public class TowerUpgrade {
 ...
 private final int towerLevel;      // ex: 2 (pour archer niveau 2)
 private final int cost;            // coût en points d'upgrade
 private final UpgradeEffect effect;
 
 public TowerUpgrade(String id, String name, String towerTypeId, int towerLevel, 
 ...
 public boolean appliesTo(String towerType, int level) {
     return this.towerTypeId.equals(towerType) && this.towerLevel == level;
 }
