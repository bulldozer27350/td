...
public class UpgradesController implements UpgradesApi {
    ...
    public ResponseEntity<List<UpgradeInfo>> getAllUpgrades() {
        ...
        Set<String> unlockedIds = this.beansManager.getMetaGameService().getPlayerProgress(clientId).getUnlockedUpgrades();
    ...
    public ResponseEntity<List<UpgradeInfo>> getUpgradesForTower(@PathVariable("towerTypeId") String towerTypeId) {
        String clientId = resolveClientId();
        var unlockedIds = this.beansManager.getMetaGameService().getPlayerProgress(clientId).getUnlockedUpgrades();
    ...
    public ResponseEntity<PurchaseUpgradeResponse> purchaseUpgrade(@PathVariable("upgradeId") String upgradeId) {
        String clientId = resolveClientId();
        boolean success = this.beansManager.getMetaGameService().purchaseUpgrade(clientId, upgradeId);
        int remaining = this.beansManager.getMetaGameService().getPlayerProgress(clientId).getUpgradePoints();
